const COLORS: Record<string, string> = {
  ...
  mental_health: "bg-rose-500/20 text-rose-300 border-rose-500/30",
  trades: "bg-amber-500/20 text-amber-300 border-amber-500/30",
  mentoring: "bg-violet-500/20 text-violet-300 border-violet-500/30",
  youth: "bg-blue-500/20 text-blue-300 border-blue-500/30",
  women: "bg-pink-500/20 text-pink-300 border-pink-500/30",
}
