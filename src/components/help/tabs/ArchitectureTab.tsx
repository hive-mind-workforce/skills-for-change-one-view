...
const LAYERS = [
  ...
  { id: "data", label: "Data + Privacy", nodes: [
    ...
    { id:"phi-wall", name:"PHI Wall", icon:"🔒", color:"#f43f5e", desc:"PHIPA hard rule: mental_health records are ALWAYS siloed. Enforced at SQL level, cannot be bypassed by any role or consent flag.", steps:["Every cross-program query includes","AND program != 'mental_health'","Enforced in getClients() SQL","No UI override possible"], code:"WHERE program != 'mental_health'\n-- PHIPA hard rule" },
