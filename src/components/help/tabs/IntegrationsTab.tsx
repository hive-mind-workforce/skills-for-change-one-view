  ...
  return (
    <div className="space-y-8">
      ...
      <div className="glass rounded-xl p-6">
        ...
        <p className="text-slate-500 dark:text-slate-400 text-sm">Salesforce continues as the CRM. OneView receives client data via webhook and adds outcomes tracking on top. Additive, not replacement.</p>
      </div>
