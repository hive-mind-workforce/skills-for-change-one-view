    ...
    <div className="space-y-6">
      ...
      <Tabs defaultValue="about" className="w-full">
        <TabsList className="bg-white/[0.04] border border-white/[0.08] p-1 h-auto flex flex-nowrap overflow-x-auto gap-1 w-full justify-start scrollbar-none">
          ...
          <TabsTrigger value="diagrams" className="flex items-center gap-1.5 text-slate-400 hover:text-slate-200 data-active:bg-emerald-500/20 data-active:!text-emerald-400"><GitMerge size={14} />Diagrams</TabsTrigger>
        </TabsList>
