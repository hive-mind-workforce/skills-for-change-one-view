...
export default function Header() {
  ...
  return (
    <header className="sticky top-0 z-50 glass border-b border-white/[0.08] h-16 flex items-center px-4 md:px-6 gap-4">
      ...
      <div className="hidden sm:flex items-center gap-1 bg-white/[0.04] rounded-lg p-1">
